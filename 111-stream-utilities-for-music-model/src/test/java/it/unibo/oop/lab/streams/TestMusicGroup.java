...
final class TestMusicGroup {
    ...
    void testOrderedSongNames() {
        final List<String> result = Arrays.asList(new String[] { //NOPMD: Exercises required it
                "Black Dog",
                "Dazed and Confused",
    ...
    void testAlbumInYear() {
        final List<String> result = Arrays.asList(new String[] { II, I }); //NOPMD: Exercises required it
